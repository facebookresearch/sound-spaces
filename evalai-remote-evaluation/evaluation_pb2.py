...
_ENVIRONMENT = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='use_planning_env',
    full_name='evaluation.Environment.use_planning_env',
    index=6,
    containing_service=None,
    input_type=_PACKAGE,
    output_type=_PACKAGE,
